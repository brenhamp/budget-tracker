...
I had a problem getting this to work correctly on Heroku at first. The api routes would return with a 503 status and I wasn't sure why. Turns out I had a whitelist restriction and needed to add 
